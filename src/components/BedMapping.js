    ...
    <div className="h-screen">
      ...
      <div className="flex justify-between">
        <div className="flex justify-start flex-row ">
          ...
          <input
            type="text"
            className="h-7 mx-2 my-2   border border-gray-300 bg-blue-gray-200"
          />
        ...
        <div className="flex justify-end flex-row mx-2 my-2  ">
          <Button className="bg-blue-gray-300 mx-2 h-7 flex items-center font-semibold text-black">
            PM Jay
          </Button>
          <Button className="bg-blue-gray-300 mx-2 h-7 flex items-center font-semibold text-black">
            Critical
      ...
      <div className="grid grid-cols-12 border border-black w-90 h-5/6 mx-4 my-2 "></div>
    </div>
  );
};
