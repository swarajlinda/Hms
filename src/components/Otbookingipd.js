...
<input type="text" className="bg-white border-black border" />
    ...
    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
      ...
      Provisional Diagnosis 
          ...
          <th scope="col" className="px-6 py-3">ward ID
          </th>
          <th scope="col" className="px-6 py-3">DOB
          </th>
          <th scope="col" className="px-6 py-3">
          Service No.1
          </th>
          <th scope="col" className="px-6 py-3">BillCardId</th>
          <th scope="col" className="px-6 py-3">collection Center Id </th>
          <th scope="col" className="px-6 py-3">Advance </th>
          <th scope="col" className="px-6 py-3">CorprateGroupID</th>
          <th scope="col" className="px-6 py-3">Department ID</th>
          <th scope="col" className="px-6 py-3">Ayushman</th>
        </tr>
...
<td className="px-6 py-4">
  ...
  ></a>
    ...
    <div className='col-span-5'>
     <div className=''>
    <p className='font-bold text-black my-7 '>OT Booking IPD patient : Mr alios Kerketta </p>
    </div>
  ...
  <td className="px-6 py-4"></td>
    ...
    <Button color="green" className='bg-green-900'>BookingNew</Button> 
    </div>
    <div className='mr-8 flex-shrink '>
    <Button color="green" className='bg-green-900'>Modify Booking</Button>
    </div>
    <div className='mr-6 flex-grow'>
    <Button color="green" className='bg-green-900'>cancel Booking</Button>
    </div>
    <div>
    <Button color="green" className='bg-green-900'>clear</Button>
    </div>
...
/>
    ...
    <textarea name="" id="" cols="65" rows="5" className='border-black border mx-10'></textarea>
    </div>
...
<textarea name="" id="" cols="78" rows="6" className='px-1 border border-black'></textarea>
</div>
</div>
    </div>
    </div>
