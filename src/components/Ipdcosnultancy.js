  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-12">
        ...
        <div className="w-full font-semibold bg-gray-500 p-2">
        EMR No.
          <input type="text" className="bg-white border-b border-black  m-2 px-2" />
   ...
   ></textarea>
        ...
        Prescription
<input type="text" className="px-2 py-2 my-2 mx-2 border-spacing-2 border-2 border-zinc-700 "/>
<button className="border-zinc-500 w-14 font-semibold "> Print </button>
 </div>
          ...
          <p className="float-left font-bold">Signature of Treatment Consultant </p>
          <input type="text" className="px-8 mx-2" />
          <div className="flex float-right space-x-5 mb-3 mx-4">
          <button className="border shadow-md rounded px-3 py-1 bg-white">Save</button>
         
          </div>
          
    
          <div className="my-3">
          <textarea className="w-full px-3 py-1 rounded outline-blue-200 border border-gray-200" rows="5" name="textData"></textarea>
          </div>
