    ...
    <div className="">
      ...
      <div className="grid grid-cols-12 h-screen">
        <div className="col-span-4 ">
          ...
          <div className="flex">
            <p className="mx-2 ">Consultant</p>
            <input type="text" className="border border-black w-4/5 mx-2 " />
          </div>
          <div className="flex my-2 ">
            <p className="mx-2 ">WardName</p>
            <input type="text" className="border border-black w-4/5 mx-2 " />
          </div>

          <div className="flex ">
            <p className="mx-2 ">patientName</p>
            <input type="text" className="border border-black w-3/5   " />
            <Button className="bg-blue-gray-500 h-7 mx-8 flex items-center">
              Show
            </Button>
          </div>
        ...
        <div className="col-span-3 border border-black w-11/12 h-5/6 mx-2 my-4 "></div>
        <div className="col-span-5 border border-black w-11/12 h-5/6 mx-2 my-4  "></div>
      </div>
    </div>
  );
};
